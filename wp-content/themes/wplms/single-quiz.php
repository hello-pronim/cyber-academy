    ...
    <div class="<?php echo vibe_get_container(); ?>">
        ...
        <?php
            if(is_user_logged_in()){
                if(isset($quiztaken) && $quiztaken && !$react_quizzes){
                    if($quiztaken > time()){
                ...
                echo '<a class="button create-group-button full"> '.__('Login to Start the Quiz','vibe').'</a>';
    ...
    <div class="<?php echo vibe_get_container(); ?>">
        ...
        if($react_quizzes){
            ...
            <div class="content">
                ...
                <?php
                    do_action('wplms_front_the_quiz',get_the_ID());
...
<?php
do_action('wplms_front_end_quiz_end',get_the_ID());
