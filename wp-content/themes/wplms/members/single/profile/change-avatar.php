 ...
 -->
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p style="color: grey; font-size: 13px;"><?php _e( 'Click below to select a JPG, GIF or PNG format photo from your computer and then click \'Upload Image\' to proceed.', 'vibe' ); ?></p>
			...
			<p id="avatar-upload">
				...
				<a class="button edit" href="<?php bp_avatar_delete_link(); ?>" title="<?php _e( 'Delete Avatar', 'vibe' ); ?>"><?php _e( 'Delete My Avatar', 'vibe' ); ?></a>
				<?php endif; ?>
			</p>
