...
if (isset($_POST["_token"]) && !empty($_POST["_token"])) {
	if($accessToken == $_POST["_token"]) {
		...
		if ($pass != "Type Password") {		
			...
			?>
<script>
window.location.replace("https://cyber-academy.t-scop.com/my-account/student/");
</script>
<?php 
		}
	}
                    ...
                    <table>
                        ...
                        <tr class="row">
                            <td class="col-12 col-md-6">
                                ...
                                <input type="text"
                                    value="<?php echo date("m / d / Y", strtotime($result_infos->user_registered));?>"
                                    readonly />
                                <?php } else {
                            ...
                            <td class="col-12 col-md-6">
                                ...
                                <input type="text" name="profile_email"
                                    value="<?php echo $result_infos->user_email; ?>" />
                                <?php } else { ?>
                        ...
                        <tr class="row">
                            <td class="col-12 col-md-6">
                                <p>New Password</p>
                                <input type="password" id="profile_new_pass" name="profile_new_pass"
                                    value="Type Password" minlength="8" required />
                            </td>
                            <td class="col-12 col-md-6">
                                <p>Confirm Password</p>
                                <input type="password" id="profile_confirm_pass" name="profile_confirm_pass"
                                    value="Type Password" minlength="8" required />
                            </td>
                        </tr>
                    </table>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="progress course_progress" style="background-color: #efefef;padding: 0;">
                                <div class="bar animate stretchRight"
                                    style="width: <?php echo $progressPercent;?>%; background-color:#6cb1ef;"></div>
                            </div>
