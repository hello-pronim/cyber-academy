...
<div id="global" class="global">
    ...
    <div class="pusher">
        ...
        ?>
        <header class="customize-inst <?php if(isset($fix) && $fix){echo 'fix';} ?>">
						...
						<div class="row main-menu">
							<div class="col-md-10">
								<?php 						
									...
									$message_url = bp_loggedin_user_domain().'messages';
								?>								
								<script>
									(function($) {
										let url = "<?php echo $message_url; ?>";
										$("#main-menu-item-4770 a").attr("href", url);
									})(jQuery);
								</script>
							</div>
							
							<ul class="topmenu col-md-2">
								<?php
