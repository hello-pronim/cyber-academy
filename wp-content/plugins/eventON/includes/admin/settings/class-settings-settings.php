			...
			array(
				...
				'fields'=> apply_filters('eventon_settings_general', array(
					...
					array('id'=>'evcal_additional',
						'type'=>'subheader',
						'name'=>__('Autonomus Functions' ,'eventon')),
	...
	// html for diagnosis content
		function content_diag(){
			...
			<div class="diagnosis_row">
				...
				<p><?php _e('NOTE: if you are having trouble sending emails via your website, we suggest using a SMTP plugin or using <a href="https://wordpress.org/plugins/wp-ses/">Amazon SES</a>.','eventon');?></p>
			</div>
			<?php
			return ob_get_clean();
		}
