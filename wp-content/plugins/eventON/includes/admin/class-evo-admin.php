...
// admin styles and scripts
	// for event posts
		function eventon_admin_post_css() {
			...
			wp_enqueue_style( 'select2',AJDE_EVCAL_URL.'/assets/css/select2.css',array(), EVO()->version);
		...
		function eventon_admin_post_script() {
			...
			if ( $typenow == '' || $typenow == "ajde_events" ) {
				...
				wp_enqueue_script('evcal_backend_post',AJDE_EVCAL_URL.'/assets/js/admin/eventon_backend_post.js', array('jquery','jquery-ui-core','jquery-ui-datepicker'), EVO()->version, true );
