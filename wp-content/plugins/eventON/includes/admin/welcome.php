			...
			<div class='evo_welcome_page'>	
				...
				<div class='get_started'>
					<div class="get_started_in">
						<h2><a class='evo_admin_btn btn_prime' href='<?php echo admin_url('index.php?page=evo-getting-started');?>'>Get started with EventON</a></h2>
					</div>

				</div>

				<div class='evow_credits'>
					<p style='font-size:20px; margin:0; padding-bottom:3px;opacity: 0.6'><a href='http://www.ashanjay.com' target='_blank'>Product of AshanJay Designs LLC</a></p>
					<p style='text-transform:uppercase; opacity:0.3; margin:0; color:#fff'>Made in USA</p>
				</div>
			</div>
		<?php
		}
