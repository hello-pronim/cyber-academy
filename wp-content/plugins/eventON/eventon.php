...
class EventON {
	...
	private function includes(){		
		...
		include_once( 'includes/class-calendar.php' );// deprecating
		include_once( 'includes/class-calendar_gen.php' );
		...
		include_once( 'includes/integration/class-intergration-elementor.php' );	
