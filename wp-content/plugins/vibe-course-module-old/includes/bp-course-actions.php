...
class BP_Course_Action{
    ...
    private function __construct(){
        ...
        */
        ...
        add_action('wp_enqueue_scripts',array($this,'add_jquery_migrate'));
        add_action('admin_enqueue_scripts',array($this,'add_jquery_migrate'));
    }
                            ...
                            foreach($instructors as $instructor){
                                if(function_exists('wc_update_order_item_meta')){
                                    ...
                                    if($commission > 0){
                                        ...
                                        bp_course_record_instructor_commission($instructor,$commission,$course,array('origin'=>'woocommerce','order_id'=>$order_id,'item_id'=>$item_id,'currency'=>$commission_item['currency']));
                                    }
