...
if( !defined('WPLMS_DASHBOARD_VERSION')){
    define('WPLMS_DASHBOARD_VERSION','3.9.9');
}
...
include_once 'includes/widgets/student/student_activity.php';
include_once 'includes/widgets/student/course_progress.php';
include_once 'includes/widgets/student/student_progress.php';
...
include_once 'includes/widgets/instructor/customize_dash_instructor_stats.php';
include_once 'includes/widgets/instructor/customize_instructor_users.php';
include_once 'includes/widgets/instructor/customoize_instructor_activity.php';
include_once 'includes/widgets/instructor/customoize_instructor_report.php';
