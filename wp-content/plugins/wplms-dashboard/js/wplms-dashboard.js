...
jQuery(document).ready(function($){
  ...
  if(wplms_dashboard_strings.multicurrency!='1'){
    ...
    if(jQuery('#instructor_commissions').length){
      ...
      if(jQuery('[id^="instructor_commissions"]').length){
          setTimeout(function () {
            $('a.currency_tabs').on('shown.bs.tab', function (e) {
            ...
            if(wplms_dashboard_strings.currencies.length){
              for (var i = wplms_dashboard_strings.currencies.length - 1; i >= 0; i--) {
                
                if(window.instructor_commission_data[wplms_dashboard_strings.currencies[i]]){
                  Morris.Line({
                    element: 'instructor_commissions_'+wplms_dashboard_strings.currencies[i],
                    data: window.instructor_commission_data[wplms_dashboard_strings.currencies[i]],
                    xkey: 'date',
                    ykeys: ['sales','commission'],
                    labels: [wplms_dashboard_strings.earnings,wplms_dashboard_strings.payout],
                    lineColors: ['#23b7e5','#fa7252'],
                  ...
                  jQuery('#instructor_commissions_'+wplms_dashboard_strings.currencies[i]).text(wplms_dashboard_strings.no_data);
                }
                if(window.commission_breakup[wplms_dashboard_strings.currencies[i]]){
                  Morris.Donut({
                    element: 'commission_breakup_'+wplms_dashboard_strings.currencies[i],
                    data: window.commission_breakup[wplms_dashboard_strings.currencies[i]],
                    colors:['#7266ba','#23b7e5','#f05050','#fad733','#27c24c','#fa7252'],
                    resize:true
                  });
                }else{
                  jQuery('#commission_breakup_'+wplms_dashboard_strings.currencies[i]).text(wplms_dashboard_strings.no_data);
                }
              }
            }
          },1000);
