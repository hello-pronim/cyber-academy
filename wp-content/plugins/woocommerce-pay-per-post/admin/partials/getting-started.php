<div class="wrap about-wrap full-width-layout">
	...
	<?php if ( wcppp_freemius()->is_not_paying() && ! wcppp_freemius()->is_trial() ) : ?>
        <a href="<?php echo wcppp_freemius()->get_upgrade_url(); ?>"><img src="<?php echo plugin_dir_url( __DIR__ ) . 'img/upgrade.png'; ?>" style="position:fixed; right:0; bottom:0; margin-right:20px; margin-top:20px; max-width:250px;"/></a>
	<?php endif; ?>
    ...
    <div class="headline-feature">
        ...
        <div class="inline-svg aligncenter">
            <img src="<?php echo plugin_dir_url( __DIR__ ) . 'img/videos/select-product.gif'; ?>" width="100%">
        </div>
    </div>
    ...
    <div class="feature-section is-wide has-2-columns is-wider-left">
        ...
        <div class="column">
            <div class="inline-svg aligncenter">
                <img src="<?php echo WC_PPP_URL; ?>/admin/img/woocommerce_logo.svg" alt="" >
            </div>
        </div>
    </div>
    <hr />
    ...
    <div class="feature-section is-wide has-2-columns is-wider-right">
        <div class="column">
            <div class="inline-svg aligncenter">
                <img src="<?php echo WC_PPP_URL; ?>/admin/img/wordpress-logo.svg" alt="" style="width:120px; height:120px;">
            </div>
        </div>
        <div class="column is-vertically-aligned-center">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/ZepEicA3yeA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    <br><br>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/UEjs8JCknFU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <hr />
